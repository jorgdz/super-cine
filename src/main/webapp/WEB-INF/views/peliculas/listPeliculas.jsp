                        ...
                        <c:forEach items="${peliculas.content}" var="pelicula">  
                        	<tr>         	             
	                            ...
	                            <td>
	                                ...
	                                <a href="${root}/destroy/${pelicula.id}" onclick="return confirm('Estás seguro')" class="btn-floating btn-small waves-effect waves-light red"><i class="material-icons">delete</i></a>
	                            </td>
                           	</tr>                         
                        </c:forEach>
